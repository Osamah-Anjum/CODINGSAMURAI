    ...
    return (
        <section id="Contact" className='contact--section'>
            <div>
                ...
                <h2>Contact Me</h2>
                <p className='text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, recusandae.</p>
            </div>
            <form className='contact--form--container'>
                ...
                <label htmlFor="choose-topic" className='contact--label'>
                    ...
                    <label htmlFor="checkbox" className="checkbox--label">
                        ...
                        <span className="text-md">I accept the Terms & Conditions.</span>
                    </label>
                    <div>
